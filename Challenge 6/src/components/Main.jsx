            ...
            <div className="row align-items-center justify-content-center">
              ...
              >
                <h2 className="mb-3 fw-boldanimate__animated animate__bounce">
                  Best Car Rental for any kind of trip in Sumedang Utara!
                </h2>
                <p className="align-content-sm-center">
                  Sewa mobil di Sumedang Utara bersama Binar Car Rental jaminan
                ...
                <div className="card-body ">
                  <div className="container">
                    <h2 className="card-title fw-bold text-white mt-2">
                      Sewa Mobil di Sumedang Utara Sekarang
                    </h2>
